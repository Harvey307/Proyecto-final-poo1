...
public:
	...
	//void no retorna nada solo realiza una accion
	...
	FacturaDetalle buscarPorCod(int codigo)
	{
		FacturaDetalle objError;
		objError.setcodFactura(0);
		//bota un producto
	...
	int getPostArray(FacturaDetalle obj)
		//te da la poscicion de objeto enviado
	{
	...
	//los metodos de un archivo no tienen nada que ver con otro archivo
	//puedes crear un metdodo de ejm sume y puedes llamarlo en cualquier emtodo que llames
	vector<FacturaDetalle> vectorfacdet()//devuelve el vector de tipo Facturadetalle
	{
		return vectorFacturaDetalle;//devuelve lo alamacenado  en esta variable
	}
};